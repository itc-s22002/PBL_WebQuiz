    ...
    return (
        ...
        {quiz ? (
                ...
                <div onClick={() => router.push(`/explanation?choiseid=${choice[3].id}&quizid=${choice[3].quiz_id}`)} style={{width: 141.96, height: 33, left: 283, top: 200, position: 'absolute'}}>
                  ...
                  <div style={{width: 74.13, height: 18.78, left: 34, top: 0, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 20, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>{choice[3].choice}<br/></div>
                </div>
                <div onClick={() => router.push(`/explanation?choiseid=${choice[2].id}&quizid=${choice[2].quiz_id}`)}style={{width: 141.96, height: 33, left: 73, top: 200, position: 'absolute'}}>
                  <div style={{width: 141.96, height: 33, left: 0, top: 0, position: 'absolute', background: '#F36D6D', borderRadius: 20}} />
                  <div style={{width: 74.13, height: 18.78, left: 34, top: 0, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 20, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>{choice[2].choice}</div>
                </div>
                <div onClick={() => router.push(`/explanation?choiseid=${choice[1].id}&quizid=${choice[1].quiz_id}`)} style={{width: 141.96, height: 33, left: 283, top: 141, position: 'absolute'}}>
                  <div style={{width: 141.96, height: 33, left: 0, top: 0, position: 'absolute', background: '#F36D6D', borderRadius: 20}} />
                  <div style={{width: 74.13, height: 18.78, left: 34, top: 0, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 20, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>{choice[1].choice}</div>
                </div>
                <div style={{left: 92, top: 42, position: 'absolute', textAlign: 'center', color: 'black', fontSize: 20, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>{quiz.question}</div>
                <div onClick={() => router.push(`/explanation?choiseid=${choice[0].id}&quizid=${choice[0].quiz_id}`)} style={{width: 141.96, height: 33, left: 73, top: 141, position: 'absolute'}}>
                  <div style={{width: 141.96, height: 33, left: 0, top: 0, position: 'absolute', background: '#F36D6D', borderRadius: 20}} />
                  <div style={{width: 74.13, height: 18.78, left: 34, top: 0, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 20, fontFamily: 'Inter', fontWeight: '400', wordWrap: 'break-word'}}>{choice[0].choice}</div>
                </div>
              </div>
        ):(
                <></>
